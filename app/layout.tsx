      ...
      offers: [
        {
          ...
          price: '0',
          priceCurrency: 'USD',
          description: '5 AI responses per month, 1 location, copy-paste responses, basic tone settings',
        },
        {
          '@type': 'Offer',
          name: 'Starter',
          price: '19',
          priceCurrency: 'USD',
          description: '30 AI responses per month, up to 3 locations, one-tap posting, dispute detection alerts, custom tone, email notifications',
        },
        {
          '@type': 'Offer',
          name: 'Pro',
          price: '39',
          priceCurrency: 'USD',
          description: 'Unlimited AI responses, unlimited locations, auto-posting, full dispute filing, recovery outreach (email + SMS), analytics dashboard, priority support',
        },
      ],
    },
    featureList: [
